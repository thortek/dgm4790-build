angular.module('starter.services', ['ngResource'])
    ...
    .factory('eventStartDateService', function(eventService){
        return{
    ...
    .factory('eventService', function($resource) {
        ...
        return {
            getEvents : function() {
                return $resource('http://uvutest.learningcomponents.com/api/events/_design/v1p0/_rewrite/api/events', {});
            },
            addEvent :  function() {
                return $resource('http://uvutest.learningcomponents.com/api/events/_design/v1p0/_rewrite/api/addevent');
            },
            deleteEvent : function(eventID, revID) {
                console.log(eventID + revID);
                return $resource('http://uvutest.learningcomponents.com/api/events/_design/v1p0/_rewrite/api/event/:id?rev=:rev', {id:eventID, rev:revID});
            }
